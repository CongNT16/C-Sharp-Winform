...
namespace AutomobileWinApp
{
    public partial class frmCarManagement : Form
    {
        ...
        private void ClearText()
        {
            ...
            txtRealeaseYear.Text = string.Empty;
        }
        //------------
        private Car GetCarObject()
        {
            ...
            try
            {
                car = new Car
                {
                    ...
                    ReleaseYear = int.Parse(txtRealeaseYear.Text)
                };
            }
            catch (Exception ex)
            {
